chunk: request
	"Return Smalltalk sourcecode as a chunk from the changes file.  URL = machine:80/myswiki.chunk.Point|at:  included are:  Point|at:   Point|Comment   Point|Hierarchy  Point|Definition   Point|class|x:y: 
