testKernelPackage
	...
	self assert: ((kernelPackage coreMethodsForClass: Object) allSatisfy: [:m | m isKindOf: MethodReference]).
	...
	self deny: ((kernelPackage coreMethodsForClass: Object) 
						includesAllOf: (Object methodDict values collect: [:cm | cm methodReference])).
