setUp
	...
	elementNotIn := 99.
	collection := OrderedCollection new add: 1; add: -2; add: 3; add: 1; yourself.
	indexArray := { 3. 1.}.
	...
	result := OrderedCollection new add: SmallInteger; add: SmallInteger; add: SmallInteger; yourself.
