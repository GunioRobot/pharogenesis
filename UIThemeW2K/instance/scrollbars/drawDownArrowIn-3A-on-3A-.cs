drawDownArrowIn: aRectangle on: aCanvas
	...
	aTriangleRect := (Rectangle origin: theCenter extent: 0@0) translateBy: (0@((aHalfWidth/3.5) asInteger)).
	aSlope := aHeight/aHalfWidth.
	[aTriangleRect width < aHeight] whileTrue: 
		[		
				aCanvas line: aTriangleRect topLeft to: aTriangleRect topRight color: anEnabledColor.
