drawRightArrowIn: aRectangle on: aCanvas 
	...
	"aTriangleRect := (Rectangle origin: theCenter extent: 0@0) translateBy: (((aHalfHeight/4) asInteger negated)@0)."
	aTriangleRect := (Rectangle origin: theCenter extent: 0@0)	 translateBy: (((aHalfHeight/3) asInteger)@0).
	aSlope := aWidth/aHalfHeight.
	[aTriangleRect height < aWidth] whileTrue: 
		[		
				aCanvas line: aTriangleRect bottomLeft to: aTriangleRect topLeft color: anEnabledColor.
